...
namespace Client.ServiceDMO {
    ...
    public interface IServiceDMO {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDMO/DeleteProduct", ReplyAction="http://tempuri.org/IServiceDMO/DeleteProductResponse")]
        System.Threading.Tasks.Task<string> DeleteProductAsync(int id, string role, int supplierId);
    ...
    public partial class ServiceDMOClient : System.ServiceModel.ClientBase<Client.ServiceDMO.IServiceDMO>, Client.ServiceDMO.IServiceDMO {
        ...
        public string DeleteProduct(int id, string role, int supplierId) {
            return base.Channel.DeleteProduct(id, role, supplierId);
        }
        
        public System.Threading.Tasks.Task<string> DeleteProductAsync(int id, string role, int supplierId) {
            return base.Channel.DeleteProductAsync(id, role, supplierId);
        }
